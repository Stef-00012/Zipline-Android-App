...
private const val TAG = "ZiplineApi[createFolder]"
...
suspend fun createFolder(
    ...
    try {
        ...
        val requestBody = CreateFolderBody(
            name = name,
            isPublic = isPublic,
            files = files,
            parentId = parentId
        ...
        val response = ZiplineApiClient.getZiplineApiService(serverUrl).createFolder(
            token = token,
            data = requestBody
        )
