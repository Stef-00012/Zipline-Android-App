					...
					{userToEdit && (
						<View style={styles.popupContent}>
							...
							<Button
								...
								rippleColor="gray"
								text={editAvatar ? editAvatarName as string : "Select an Avatar..."}
								onPress={async () => {
							...
							<Select
								...
								onSelect={(selectedRole) => {
									...
									setEditRole(selectedRole[0].value as Exclude<APIUser["role"], "SUPERADMIN">)
								}}
				...
				<Popup hidden={!createNewUser} onClose={() => {
					...
					<View style={styles.popupContent}>
						...
						<Button
							...
							rippleColor="gray"
							text={newUserAvatar ? newUserAvatarName as string : "Select an Avatar..."}
							onPress={async () => {
								const output = await DocumentPicker.getDocumentAsync({
									type: [
										"image/png",
						...
						<Select
							...
							onSelect={(selectedRole) => {
								...
								setNewUserRole(selectedRole[0].value as Exclude<APIUser["role"], "SUPERADMIN">)
							}}
							placeholder="Select Role..."
