...
export const avaibleTextMimetypes: SelectProps["data"] = [
	...
	{ label: "Dockerfile", value: "dockerfile", mimetype: "text/x-zipline-dockerfile" },
	{ label: "Lua", value: "lua", mimetype: "text/x-zipline-lua" },
	{ label: "NGINX Config File", value: "conf", mimetype: "text/x-zipline-nginx-conf" },
	...
	{ label: "Handlebars", value: "hbs", mimetype: "text/x-zipline-handlebars-template" },
	...
	{ label: "CoffeeScript", value: "coffee", mimetype: "text/x-zipline-coffeescript" },
