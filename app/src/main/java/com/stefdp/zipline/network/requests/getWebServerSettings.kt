...
private const val TAG = "ZiplineApi[getWebServerSettings]"
...
suspend fun getWebServerSettings(
    ...
    try {
        ...
        val response = ZiplineApiClient.getZiplineApiService(serverUrl).getWebServerSettings(
            token = token,
        )
