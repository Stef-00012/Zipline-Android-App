...
private const val TAG = "ZiplineApi[getPublicFolderData]"
...
suspend fun getPublicFolderData(
    ...
    try {
        ...
        val response = ZiplineApiClient.getZiplineApiService(serverUrl).getPublicFolderData(
            token = token,
            folderId = folderId,
            filterAllowedUploadsOnly = filterAllowedUploadsOnly
        )
