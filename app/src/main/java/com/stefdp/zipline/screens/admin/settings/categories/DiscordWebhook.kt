...
internal fun DiscordWebhookCategory(
    ...
    Container(
        ...
        Column(
            ...
            var webhookUrl by remember(settings?.settings?.discordWebhookUrl) {
            ...
            var username by remember(settings?.settings?.discordUsername) {
            ...
            var avatarUrl by remember(settings?.settings?.discordAvatarUrl) {
